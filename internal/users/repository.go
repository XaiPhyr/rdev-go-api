...
func (r *Repository) GetUserByUsernameOrEmail(ctx context.Context, identifier string) (*User, error) {
	var user = new(User)
...
func (r *Repository) GetUsers(ctx context.Context, q dto.BaseFilters) ([]User, int, error) {
	var users []User
...
func (r *Repository) UpdateUserStatus(ctx context.Context, uuid string) error {
	_, err := r.db.NewUpdate().
		Model((*User)(nil)).
